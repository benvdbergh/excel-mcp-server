...
| 13 | [Epic-13](Epics/Epic-13-table-catalog-and-row-query.md) | Table catalog and row query *(delivered; **0.6.0**)* |
| 14 | [Epic-14](Epics/Epic-14-excel-view-from-query-spec.md) | Excel view from a query spec *(delivered; **0.6.0**)* |
...
**Traces to:** [ADR 0009](../../architecture/adr/0009-open-workbook-discovery-tool.md), [COM-first workbook session design](../../architecture/com-first-workbook-session-design.md) §2.1, [ADR 0006](../../architecture/adr/0006-cloud-workbook-locator-sharepoint-urls.md) (`FullName`), [ADR 0002](../../architecture/adr/0002-com-automation-stack.md).

**Depends on:** Epic-11 delivered (COM-first + lifecycle narrative stable).

### Stories (summary)

| Story | Title |
|-------|--------|
| [12-1](Stories/Story-12-1-com-enumerate-open-workbooks-json-contract.md) | COM enumeration + JSON contract + mocks |
| [12-2](Stories/Story-12-2-mcp-tool-wire-discovery-handler-and-schema.md) | MCP tool, schema, routing classification |
| [12-3](Stories/Story-12-3-tests-tools-md-readme-operator-validation.md) | TOOLS.md, README, changelog, manual validation |

### Dependency graph (logical)

```mermaid
flowchart TD
  S121[12-1 COM enumerate JSON]
  S122[12-2 MCP wire tool]
  S123[12-3 Docs and CI polish]
  S121 --> S122
  S122 --> S123
```

**Rough effort (Epic-12):** **4–10 developer-days** total (see epic document).
